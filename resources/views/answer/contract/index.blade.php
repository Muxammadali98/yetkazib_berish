        ...
        <div class="col-12 col-md-6 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Shartnomachi yangi buyurtmalari</h4>
                </div>
                <div class="card-body">
                            ...
                            @forelse($answers as $item)
                                <tr>
                                    ...
                                    <td class="d-flex" style="gap: 5px;">
                                        <a href="#" class="btn btn-success accept-app" data-toggle="modal" title="Qabul qilish" data-id="{{ $item->application_id }}" data-url="{{ route('answer.contractAccepted', $item->application_id) }}" data-name="{{ $item->client->full_name }}" data-target="#exampleModalCenter"><i class="fas fa-check"></i></a>
                                        <a href="#" class="btn btn-danger close-app" data-toggle="modal" title="Bekor qilish" data-id="{{ $item->application_id }}" data-url="{{ route('answer.contractCancel', $item->application_id) }}" data-name="{{ $item->client->full_name }}" data-target="#exampleModalCenter"><i class="fas fa-times"></i></a>
