                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="title_uz" class="form-control @error('title_uz') is-invalid @enderror" value="{{ old('title_uz') }}" required>
                                    @error('title_uz')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="title_ru" class="form-control @error('title_ru') is-invalid @enderror" value="{{ old('title_ru') }}" required>
                                    @error('title_ru')
                                    <div class="invalid-feedback">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" class="form-control">
                                        ...
                                        @foreach($categoryList as $key => $value)
                                            <option value="{{ $key }}" @if($key == old('parent_id')) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="channel_link" class="form-control @error('channel_link') is-invalid @enderror" value="{{ old('channel_link') }}" required>
                                    @error('channel_link')
                                    <div class="invalid-feedback">
