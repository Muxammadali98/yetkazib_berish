        ...
        <div class="col-12 col-md-6 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Javob xabarini o'zgartirish</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                    ...
                    <form action="{{ route('message.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control @error('type') is-invalid @enderror" required>
                                        @foreach(\App\Models\Message::getType() as $key => $value)
                                            <option value="{{ $key }}" @if($model->type == $key) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('type')
                                    <div class="invalid-feedback">
