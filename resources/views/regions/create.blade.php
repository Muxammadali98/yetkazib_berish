                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('region.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Filial manzil linki</label>
                                    <input type="text" name="address_link" class="form-control @error('address_link') is-invalid @enderror" value="{{ old('address_link') }}" required>
                                    @error('address_link')
                                    <div class="invalid-feedback">
                                        Filial manzil linki to'ldirilishi shart
                                    </div>
                                    @enderror
                                </div>
                            </div>
