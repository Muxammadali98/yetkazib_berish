                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <x-text-input id="name" class="form-control" type="text" name="name" :value="$model->name" required autofocus />
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    <x-text-input id="email" class="form-control" type="email" name="email" :value="$model->email" required />
                        ...
                        <div class="row">
                                ...
                                <div class="mt-4">
                                    ...
                                    <select name="roles[]" id="roles" class="form-control select2" multiple>
                                        @foreach($roles as $key => $value)
                                            <option value="{{ $key }}" @if(in_array($key, $user_roles)) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="phone_number" class="form-control" type="text" name="phone_number" :value="$model->phone_number" required autofocus />
                                ...
                                <div class="mt-4">
                                    ...
                                    <select name="region_id[]" id="region_id" class="form-control select2" multiple>
                                        @foreach($regions as $key => $value)
                                            <option value="{{ $key }}" @if(in_array($key, $regionsId)) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                </div>
