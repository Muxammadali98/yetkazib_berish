            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('ticket.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="user_id" class="form-control @error('user_id') is-invalid @enderror" required>
                                        ...
                                        @foreach(\App\Models\Ticket::getTypes() as $key => $value)
                                            <option value="{{ $key }}" {{ $model->type == $key ? 'selected' : '' }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('user_id')
                                    <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="client_name" class="form-control @error('client_name') is-invalid @enderror" value="{{ $model->client_name }}" required>
                                    @error('client_name')
                                    <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contract_id" class="form-control @error('contract_id') is-invalid @enderror" value="{{ $model->contract_id }}" required>
                                    @error('contract_id')
                                    <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('comment') is-invalid @enderror" name="comment">{{ $model->comment }}</textarea>
                                    @error('comment')
                                    <div class="invalid-feedback">
                        ...
                        <div class="row" id="btn-row" data-count="{{ count($model->products) - 1 }}">
                            @foreach($model->products as $key => $product)
                                <div class="row col-12">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Mahsulot nomi</label>
                                            <input type="text" class="form-control" name="product_name[{{ $key }}]" required  value="{{ $product->product_name }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Model</label>
                                            <input type="text" class="form-control" name="model[{{ $key }}]" required  value="{{ $product->model }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Artikul</label>
                                            <input type="text" class="form-control" name="article[{{ $key }}]" required  value="{{ $product->article }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Miqdori</label>
                                            <input type="number" class="form-control" name="quantity[{{ $key }}]" required  value="{{ $product->quantity }}">
                                        </div>
                                    </div>
                                    <div class="col-md-1">
