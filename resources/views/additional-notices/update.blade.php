        ...
        <div class="col-12 col-md-6 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('additional-notice.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title_uz') is-invalid @enderror" name="title_uz" value="{{ $model->title_uz }}" required>
                                    @error('title_uz')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title_ru') is-invalid @enderror" name="title_ru" value="{{ $model->title_ru }}" required>
                                    @error('title_ru')
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="regions[]" class="form-control select2 @error('regions') is-invalid @enderror"  multiple required>
                                        @foreach($regions as $key => $value)
                                            <option value="{{ $key }}" @if(in_array($key, \App\Repositories\AdditionalNoticeRepository::getIds($model->id))) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('regions')
                                    <div class="invalid-feedback">
